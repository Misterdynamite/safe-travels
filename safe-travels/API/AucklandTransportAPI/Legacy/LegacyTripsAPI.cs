...
namespace safe_travels.API.AucklandTransportAPI.Legacy
{
    class LegacyTripsAPI
    {
        ...
        /// <summary>
        /// Retrieves a list of trips whose IDs contain the specified input string.
        /// </summary>
        /// <param name="tripIdInput">The partial or full trip ID to search for.</param>
        /// <returns>A list of <see cref="TripData"/> objects matching the search criteria.</returns>
